    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organized_events', models.ManyToManyField(blank=True, related_name='event_organizer', to='events.event')),
            ],
        ),
        migrations.CreateModel(
            name='Attendee',
            fields=[
                ...
                ('email', models.EmailField(max_length=254)),
                ('first_name', models.CharField(max_length=100)),
                ('registered_events', models.ManyToManyField(blank=True, related_name='event_attendee', to='events.event')),
            ],
        ),
    ]
